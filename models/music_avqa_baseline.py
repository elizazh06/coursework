...
class MusicAVQABaselineModel(nn.Module):
    ...
    def __init__(self, vocab_size=5000, hidden_dim=512, num_classes=42, dropout=0.1, num_heads=4):
        super().__init__()
        ...
        self.question_encoder = QuestionEncoder(vocab_size=vocab_size, word_embed_size=hidden_dim, embed_size=hidden_dim, num_layers=1, hidden_size=hidden_dim)
